...
const ItemArray = [
    ...
    new loreItem("spimton:galena_necklace", ["§r§7When on Chest:", " §r§9Applies §cSlowness II", " §r§9Has a §e20%§7 chance to inflict", " §r§5[Profound Brain Damage] §9to attackers"]),
    new loreItem("spimton:might_necklace", ["§r§7When on Chest:", " §r§9Applies §aStrength III", " §r§9Applies §aJump Boost III"]),
    new loreItem("spimton:iridescence_necklace", ["§r§9When on Chest:", " §r§7Inflicts §cBlindness§7 to attackers", " §r§9Applies a random buff when hit"]),
    new loreItem("spimton:chilling_necklace", ["§r§7When on Chest:", " §r§9Inflicts §cSlowness§7 to nearby entities", " §r§9Reflects 5 damage as §eFreezing damage"]),
    new loreItem("spimton:indestructibility_tiara", [" §r§9Increased durability"]),
    new loreItem("spimton:wisdom_tiara", ["§r§7When on Head:", " §r§9Gives experience when you break", " §r§9a block, get hit or hit something"]),
    new loreItem("spimton:iridescence_tiara", ["§r§7When on Head:", " §r§9Applies §aInvisibility§7 when attacked", " §r§9Inflicts a random debuff to attackers"]),
    new loreItem("spimton:nautilus_tiara", ["§r§7When on Head:", " §r§9Applies §aConduit Power§9 for §e20§7 seconds", " §r§9Recharges while out of water"]),
    new loreItem("spimton:chronos_staff", ["", "§r§7Stand: §a[Made in Heaven]", "", "§r§9Right click to activate stand", "§r§9Shift right click to stop stand"]),
    ...
    new loreItem("spimton:creeping_tiara", ["§r§7When on Head:", " §r§9Hitting an enemy will have a chance of summoning", " §r§9a §2Creepie§9. It will attack everything, including you"]),
    new loreItem("spimton:ghostly_necklace", ["§r§7When on Chest:", " §r§9Crouching will create a path of ghostly blocks", " §r§9below you, that decay over time.", " §r§4WARNING:§c staying in one place for too long", " §r§cwill result in brief instabilities, which may", " §r§ccause a 'bugrock moment' when playing on a server.", " §r§cUse it at your own risk,", " §r§c-PIPIS, Spimton"]),
